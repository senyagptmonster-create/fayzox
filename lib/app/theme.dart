...
class AppTheme {
  static const Color cBg = Color(0xFFFDFBFF);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFEBE4F5);
  static const Color cAccent = Color(0xFFA855F7);
  static const Color cAccent2 = Color(0xFFD8B4FE);
  static const Color cInk = Color(0xFF280A3D);
